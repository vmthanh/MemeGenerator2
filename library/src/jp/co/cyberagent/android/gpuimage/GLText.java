...
public class GLText {
    ...
    private  GPUTextCaptionFilter mProgram;
    ...
    //Instructor is the same, but load separate stoke pain
    public boolean loadStroke(String file, int size, int padX, int padY)
    {
        // setup requested values
        fontPadX = padX;                                // Set Requested X Axis Padding
        fontPadY = padY;                                // Set Requested Y Axis Padding
        ...
        paint.setAntiAlias( true );                     // Enable Anti Alias
        paint.setTextSize( size );                      // Set Text Size
        paint.setColor(Color.BLACK);                   // Set ARGB (White, Opaque)
        paint.setTypeface( tf );                        // Set Typeface
        paint.setStyle(Paint.Style.STROKE);             //Miracle is here
